...
hitrate_cr_1bzip2 <- read.csv("hit-rate-cr-1bzip2.csv")
cache_occ_1bzip2 <- read.csv("cache-occ-1bzip2.csv")
...
ggsave("hit-rate-cr-1bzip2.pdf",width=9, height=5.5)
...
ggsave("cache-occ-1bzip2.pdf",width=9, height=5.5)
